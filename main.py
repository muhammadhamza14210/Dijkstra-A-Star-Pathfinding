...
def main():
    ...
    for i in range(0, len(start_states)):    
        ...
        cost, expanded_diskstra = Dijsktra.dijkstra_search(start,goal,gridded_map) # replace None, None with the call to your Dijkstra's implementation
        time_end = time.time()
        ...
        time_start = time.time()
        cost, expanded_astar = A_star.astar_search(start,goal,gridded_map) # replace None, None with the call to your A* implementation
        time_end = time.time()
